...
trait IPlayer extends IUnit with INorma {
     ...
     * during which the player cannot take their turn. To exit this phase, the player must roll a die
     * and obtain a quantity greater than or equal to the required amount for recovery. If they succeed
     * in recovering, then they can immediately take their turn.
     *
